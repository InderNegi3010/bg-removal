...
const BuyCredit = () => {
  return (
    <div className="min-h-[80vh] text-center pt-14 mb-10">
      ...
      <div className="flex flex-wrap justify-center gap-6 text-left mt-9">
        {plans.map((item, index) => (
          <div className="bg-white drop-shadow-sm rounded-lg py-12 px-8 text-gray-700 hover:scale-110 transition-all duration-500" key={index}>
