  ...
  return (
      ...
      <h1 className="mb-12 sm:mb-20 text-center text-2xl md:text-3xl lg:text-4xl font-semibold mt-4 bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent leading-tight">
        ...
        <div className="relative w-full max-w-3xl overflow-hidden m-auto rounded-xl">
              ...
              {/* ------Slider ---------- */}
              <input  className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-1/2 w-full z-10 slider" type="range" min={0} max={100} value={sliderPosition} onChange={handleSliderChange}/>
        </div>
